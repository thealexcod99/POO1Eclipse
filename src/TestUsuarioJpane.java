...
public class TestUsuarioJpane {
	...
	public static void main(String[] args) {
		...
		String login = JOptionPane.showInputDialog("Por favor introduce login del usuario");
		...
		/*String password = JOptionPane.showInputDialog("Por favor introduce la contraseña del usuario");
		
		//usando wrapper lo convertimos en int
		int passwordNumero = Integer.parseInt(password);
		
		if (passwordNumero == usuario.getPassword())
			JOptionPane.showInternalMessageDialog(null, usuario, "Información de usuarios", JOptionPane.PLAIN_MESSAGE);
		
		else
			JOptionPane.showInternalMessageDialog(null, "Contraseña no válida", "Información de usuarios", JOptionPane.ERROR_MESSAGE);*/
